...
# ---------------- PHASE 4 — element layer (design + architecture realms + the bridge) ----------------
# The element layer is a distinct node kind spanning two realms; it does not touch the seven
# work passes above. build_elements.py consumes build/element_src/ and self-audits completeness
